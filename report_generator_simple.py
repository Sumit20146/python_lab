...
def uppercase(func):
    ...
    def wrapper(*args, **kwargs):
        output = func(*args, **kwargs)   # run the original function first
        return output.upper()            # then add extra behaviour
    return wrapper
...
def add_border(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        line = "-" * 45          # slightly wider border looks neater
        return line + "\n" + text + "\n" + line
    return wrapper
...
class Report:
    ...
    def word_count(self):
        """Extra helper: counts total words across all section contents."""
        total = 0
    ...
    def __len__(self):
        # Called automatically whenever len() is used on the object
...
if __name__ == "__main__":
    ...
    r2.add_section("Summary", "Overall attendance for this month stands at 92%.")
    ...
    print("---- r1.word_count() extra helper method ----")
    print(r1.word_count())
